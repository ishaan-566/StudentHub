                                   ...
                                   <tbody>
                                       <c:forEach items="${students }" var="student">
                                           ...
                                           <td><span class="list-icon"><img class="rounded"
                                                       src="assets/images/student/${student.image }" alt="${student.fname }"></span></td>
                                           <td><span class="list-name">${student.rollnumber }</span></td>
                                           <td>${student.fname }&nbsp;${student.lname }</td>
                                           <td>${student.gender }</td>
                                           <td>${student.phone }</td>
                                           <c:choose>
                                               <c:when test = "${fn:contains(student.department, 'BCA')}">
                                                   <td><span class="badge badge-primary">${student.department }</span></td>
                                               </c:when>
                                               <c:when test = "${fn:contains(student.department, 'MCA')}">
                                                   <td><span class="badge badge-default">${student.department }</span></td>
                                               </c:when>
                                               <c:when test = "${fn:contains(student.department, 'BBA')}">
                                                   <td><span class="badge badge-info">${student.department }</span></td>
                                               </c:when>
                                               <c:when test = "${fn:contains(student.department, 'MBA')}">
                                                   <td><span class="badge badge-success">${student.department }</span></td>
                                               </c:when>
                                               <c:when test = "${fn:contains(student.department, 'PGDM')}">
                                                   <td><span class="badge badge-warning">${student.department }</span></td>
                                               </c:when>
                                               <c:otherwise>
                                                   <td><span class="badge badge-danger">${student.department }</span></td>
                                               </c:otherwise>
                                           </c:choose>
                                       </tr>
                                       </c:forEach>
